...
var p1 = new Product(1,"Colgante ojo turco",1500)
var p2 = new Product(2,"Buda porta velas",2500)
var p3 = new Product(3,"Ojo turco",1300)
var p4 = new Product(4,"Buda",2500)
var p5 = new Product(5,"Collar ojo turco",800)
var p6 = new Product(6,"Lampara de sal",3500)
...
$(function()
{
	...
	{
		window.alert("Este articulo ya existe, por favor revisa tu lista de compras!");
		return 0;
	}
